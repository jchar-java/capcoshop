...
public abstract sealed class Client permits ClientParticulier, ClientProfessionnel {
	...
	public List<Produit> getPanierProduits() {
		return this.panierProduits != null ? List.copyOf(this.panierProduits) : List.of();
	}
